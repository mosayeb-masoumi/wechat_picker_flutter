...
class EnglishAssetPickerTextDelegate extends AssetPickerTextDelegate {
  ...
  @override
  String get loadFailed => 'خطا در بارگذاری';

  @override
  String get original => 'مبدا';
  ...
  @override
  String get unableToAccessAll => 'دسترسی به همه محتویات وجود ندارد';
  ...
  @override
  String get accessLimitedAssets => 'ادامه یا محدودیت دسترسی';

  @override
  String get accessiblePathName => 'استهای قابل دسترس';
  ...
  @override
  String get sTypeOtherLabel => 'دیگر استها';

  @override
  String get sActionPlayHint => 'پلی';
